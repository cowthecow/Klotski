...
public class Piece2x1 extends Piece {
    ...
    public Piece2x1(ArrayList<Integer> piecePositions) {
    ...
    public void paint(Graphics g){
        ...
        if(!Executor.showShade)g2d.setColor(new Color(255,128,0,200));
        ...
        g2d.fillRoundRect(x*150-95,y*150-95,290,140,25,25);
    }
}
